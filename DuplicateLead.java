...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		WebElement clearCompanyNameElement = driver.findElement(By.className("tabletext"));
		clearCompanyNameElement.clear();
		
		WebElement clearFirstName = driver.findElement(By.id("viewLead_firstName_sp"));
		clearFirstName.clear();
		
		WebElement createDuplicateLeadButtonElement = driver.findElement(By.className("smallSubmit"));
		createDuplicateLeadButtonElement.click();

		System.out.println("The title is" + driver.getTitle());
		System.out.println("The current URL is" + driver.getCurrentUrl());
		System.out.println("The Page source code of the current page is" + driver.getPageSource());
	}
